...
int dynamicArrayInit(dynamicArray *pArray, int capacity)
{
    ...
    //清除脏数据
    menset (pArray->data, 0 , sizeof(ELEMENTTYPE)*capacity);
...
{
    return dynamicArrayAppointPoosInsertData(pArray, pArray->len, val);
...
//获取数组的容量
int dynamicArrayGetCapacity(dynamicArray *pArray,pCapacity);
